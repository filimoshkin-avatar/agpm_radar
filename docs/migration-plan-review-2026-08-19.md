...
По решению владельца Stage 16 является финальной границей текущего миграционного плана. На
2026-08-22 владелец подтвердил, что весь прежний 19-этапный migration/cutover plan считается
выполненным для текущей цели: Legacy остаётся отдельным production-контуром, V2 является
production-контуром на Local Ru, оба наблюдаются владельцем, а дальнейшее развитие ведётся только
в V2. Исторические Stage 17–19 ниже сохранены как архивный cutover-чеклист, но не являются
активным планом работ.

Активный post-migration план развития: `docs/radar-v2-knowledge-base-roadmap-2026-08-22.md`.
Новые задачи должны формулироваться вокруг V2 knowledge base/KX, а не вокруг Stage 17–19.

## Архив: Этап 17. Пользовательская приёмка V2
...
## Архив: Этап 18. Cutover основного домена
...
## Архив: Этап 19. Observation и завершение миграции
...
Stage 0, urgent Stage 0A и Stage 1–16 завершены. На 2026-08-22 владелец считает прежний
19-этапный миграционный план выполненным для текущей цели: Legacy есть, production V2 на Local Ru
есть, оба стенда наблюдаются. Дальнейший режим — развивать только V2, прежде всего в направлении
самопополняемой базы знаний поверх Radar KX.

Канонический следующий план: `docs/radar-v2-knowledge-base-roadmap-2026-08-22.md`.
Не продолжать новые задачи как Stage 17–19 без отдельной явной команды владельца.
